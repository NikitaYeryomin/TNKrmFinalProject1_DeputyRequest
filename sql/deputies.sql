...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 03 2017 г., 18:20
...
INSERT INTO `deputies` (`id`, `user_id`, `surname`, `name`, `patronymic`, `bio`, `tvoid`, `party_id`, `sex`) VALUES
...
(8, 64, 'Суков', 'Геннадій', 'Сергійович', 'Громадянин України, народився 26.03.1959 р., освіта вища, безпартійний, Публічне акціонерне товариство "Ново краматорський машинобудівний завод", Генеральний директор, голова правління, місце проживання: м. Краматорськ, Донецька обл.', 0, 1, 'm'),
